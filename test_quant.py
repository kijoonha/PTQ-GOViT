# python test_quant.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax
import argparse
import math
import os
import time
...
def main():
    ...
    cfg = Config(args.ptf, args.lis, args.outlier, args.quant_method)
