#python test_quant.py swin_base /home/datasets/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax --device cuda:3
...
from config import Config_8bit, Config_6bit_method, Config_4bit_method
from models import *
...
def main():
    ...
    cfg = Config_4bit_method(args.ptf, args.lis, args.outlier, args.quant_method)
