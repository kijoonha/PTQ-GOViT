#python test_quant_6bit+method.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax 
...
from config import Config_8bit, Config_6bit_method
from models import *
...
def main():
    ...
    cfg = Config_6bit_method(args.ptf, args.lis, args.outlier, args.quant_method)
