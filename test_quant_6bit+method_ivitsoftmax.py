#python test_quant_6bit+method.py swin_base /home/datasets/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax --device cuda:3
...
from config import Config_8bit, Config_6bit_method_ivitsoftmax
from models import *
...
def main():
    ...
    cfg = Config_6bit_method_ivitsoftmax(args.ptf, args.lis, args.outlier, args.quant_method)
