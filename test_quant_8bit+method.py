#python test_quant_8bit_method.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax 
#python test_quant_8bit.py deit_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax 
...
from config import Config_8bit_method
from models import *
...
parser.add_argument('--timeoutlier', default=False, action='store_true')
...
def main():
    ...
    cfg = Config_8bit_method(args.ptf, args.lis, args.outlier, args.quant_method)
    print("outlier : ", cfg.outlier)
    ...
    if args.quant:
        ...
        print('Calibrating...')
        #이후는 main함수 말고 inference_pytorch_quant에 작성 
        model.model_open_calibrate()
        with torch.no_grad():
            for i, image in enumerate(image_list):
                if i==0:
                    model.model_find_outlier()
                    output = model(image)
                    model.model_find_outlier_close()
