#python test_quant_8bit.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax 
...
from config import Config_8bit
from models import *
...
def main():
    ...
    cfg = Config_8bit(args.ptf, args.lis, args.outlier, args.quant_method)
