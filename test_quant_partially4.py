# python test_quant_partially4.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax --device cuda:3
import argparse
import math
import os
import time
...
from config import  Config_partially4bit
from models import *
...
def main():
    ...
    cfg = Config_partially4bit(args.ptf, args.lis, args.outlier, args.quant_method)
