#python test_quant_partially6.py swin_base /shared/erc/lab02/ILSVRC12 --quant --ptf --lis --outlier --quant-method minmax 
...
from config import Config_partially6bit
from models import *
...
def main():
    ...
    cfg = Config_partially6bit(args.ptf, args.lis, args.outlier, args.quant_method)
